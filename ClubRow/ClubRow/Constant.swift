...
let KEY_API_LOAD_STATISTIC_AVERAGE = "statistics/user/average"
let KEY_API_LOAD_STATISTIC_GLOBAL_AVERAGE = "statistics/class/"
let KEY_API_LOAD_STATISTIC_HISTORY = "statistics/user/history"
let KEY_API_LOAD_STATISTIC_DAILY = "statistics/user/daily"
let KEY_API_LOAD_STATISTIC_TODAY = "statistics/user/today"
